...
export class MT5CodeGenerator extends CodeGenerator<string> {
    ...
    private generateHeader(ast: StrategyNode) {
        ...
        this.code.push(
            '//|                                    Generated by Strategy AST     |'
        );
        this.code.push(
            '//|                                    ' +
                new Date().toISOString().substring(0, 19).padEnd(30) +
                '|'
        );
        this.code.push(
            '//+------------------------------------------------------------------+'
        );
        this.code.push('#property copyright "Auto-generated"');
        this.code.push('#property link      ""');
        this.code.push('#property version   "1.00"');
        this.code.push('#property strict');
        this.code.push('');
        this.code.push('// ' + description);
        this.code.push('');
        this.code.push('#include <Trade\\Trade.mqh>');
        this.code.push('#include <Trade\\PositionInfo.mqh>');
        this.code.push('#include <Trade\\OrderInfo.mqh>');
        this.code.push('');
    }
