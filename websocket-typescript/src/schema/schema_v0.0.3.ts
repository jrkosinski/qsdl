//TODO: check that referenced ids are valid
//TODO: add english description to strategy schema
                ...
                oneOf: [
                    {
                        ...
                        properties: {
                            type: {
                                type: 'string',
                                enum: ['indicator_event', 'price_action'],
                            },
                            params: {
                                type: 'object',
                                required: [
                    ...
                    },
                    {
                        ...
                        properties: {
                            ...
                            params: {
                                type: 'object',
                                required: ['indicators', 'operator'],
                                properties: {
                                    indicators: { type: 'array' }, //TODO: check that these are valid ids
                                    operator: {
                                        type: 'string',
                                        enum: [
                                            '>',
